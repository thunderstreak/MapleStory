...
public class Eval {
    ...
    public enum Operator {
        ...
        private Operator(final int precedence, final int numberOfOperands, final String string, final Type resultType,
    ...
    public static class Operation {
        ...
        static Object tenaryOperationFactory(final Operator operator, final Object operand1, final Object operand2,
        ...
        private Operation(final Type type, final Operator operator, final Object operand1, final Object operand2,
                final Object operand3) {
            this.type = type;
        ...
        BigDecimal eval(final Map<String, BigDecimal> variables) {
            switch (this.operator.numberOfOperands) {
                case 3: {
                    return this.operator.perform(this.evaluateOperand(this.operand1, variables),
                            this.evaluateOperand(this.operand2, variables),
                            this.evaluateOperand(this.operand3, variables));
                }
                case 2: {
                    return this.operator.perform(this.evaluateOperand(this.operand1, variables),
                            this.evaluateOperand(this.operand2, variables), null);
                }
                default: {
    ...
    public static class Compiler {
        ...
        private Object compile(final Object preReadOperand, final Operator preReadOperator, final int nestingLevel,
                final char endOfExpressionChar, final int terminatePrecedence) {
            ...
            while (operator != Operator.END) {
                if (operator == Operator.TERNARY) {
                    ...
                    if (nextOperator == Operator.END) {
                        ...
                        operand = Operation.binaryOperationfactory(operator, operand, this.compile(nextOperand,
                                nextOperator, nestingLevel, endOfExpressionChar, operator.precedence));
