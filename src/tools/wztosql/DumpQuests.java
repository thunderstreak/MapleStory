...
public class DumpQuests {
    ...
    public void dumpQuests() throws Exception {
        if (!this.hadError) {
            ...
            final PreparedStatement psq = this.con.prepareStatement(
    ...
    public void dumpQuests(final PreparedStatement psai, final PreparedStatement psas, final PreparedStatement psaq,
            final PreparedStatement ps, final PreparedStatement psr, final PreparedStatement psq,
            final PreparedStatement psa) throws Exception {
        if (!this.update) {
