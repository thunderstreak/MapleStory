...
public class MapleRing implements Serializable {
    ...
    public static Equip loadFromDb(final IItem ring) {
        try {
            ...
            rs.next();
            final MapleRing ret = new MapleRing(ring.getItemId(), rs.getInt("partnerRingId"), rs.getInt("partnerChrId"),
    ...
    public static void addToDB(final int itemid, final MapleCharacter chr, final String player, final int id,
            final int[] ringId) throws SQLException {
        final Connection con = DatabaseConnection.getConnection();
    ...
    public static int createRing(final int itemid, final MapleCharacter partner1, final String partner2,
            final String msg, final int id2, final int sn) {
        try {
            if (partner1 == null) {
                return -2;
            }
    ...
    public static int makeRing(final int itemid, final MapleCharacter partner1, final String partner2, final int id2,
            final String msg, final int sn) throws Exception {
