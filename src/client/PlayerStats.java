...
public class PlayerStats implements Serializable {
    ...
    public void recalcLocalStats(final boolean first_login) {
        ...
        for (final IItem item2 : chra.getInventory(MapleInventoryType.CASH)) {
            if (this.expMod < 3 && (item2.getItemId() == 5211060 || item2.getItemId() == 5211050
                    || item2.getItemId() == 5211051 || item2.getItemId() == 5211052 || item2.getItemId() == 5211053
                    || item2.getItemId() == 5211054)) {
                this.expMod = 3;
            } else if (this.expMod == 1 && (item2.getItemId() == 5210001 || item2.getItemId() == 5210004
                    || item2.getItemId() == 5211061 || item2.getItemId() == 5211000 || item2.getItemId() == 5211001
                    || item2.getItemId() == 5211002 || item2.getItemId() == 5211003 || item2.getItemId() == 5211046
                    || item2.getItemId() == 5211047 || item2.getItemId() == 5211048 || item2.getItemId() == 5211049)) {
                this.expMod = 2;
            ...
            if (this.dropMod == 1) {
                if (item2.getItemId() == 5360009 || item2.getItemId() == 5360010 || item2.getItemId() == 5360011
                        || item2.getItemId() == 5360012 || item2.getItemId() == 5360013 || item2.getItemId() == 5360014
                        || item2.getItemId() == 5360017 || item2.getItemId() == 5360050 || item2.getItemId() == 5360053
                        || item2.getItemId() == 5360042 || item2.getItemId() == 5360052 || item2.getItemId() == 5360016
                        || item2.getItemId() == 5360015) {
                    this.dropMod = 2;
                            ...
                            for (final Integer z : ins.get(lvlz + i)) {
                                if (Math.random() < 0.1) {
                                    ...
                                    if (skil == null || !skil.canBeLearnedBy(chr.getJob())
                                            || chr.getSkillLevel(skil) >= chr.getMasterLevel(skil)) {
                                        continue;
                                    }
    ...
    private void CalcPassive_Mastery(final MapleCharacter player) {
        ...
        switch (GameConstants
            ...
            case BOW: {
                skil = (GameConstants.isKOC(player.getJob()) ? 13100000
                        : (GameConstants.isResist(player.getJob()) ? 33100000 : 3100000));
                break;
            }
            case CLAW: {
                skil = 4100000;
            ...
            case SWORD1H:
            case SWORD2H: {
                skil = (GameConstants.isKOC(player.getJob()) ? 11100000
                        : ((player.getJob() > 112) ? 1200000 : 1100000));
                break;
            }
            case BLUNT1H:
            case BLUNT2H: {
            ...
            case 2112: {
                ...
                if (critlevel > 0) {
                    this.passive_sharpeye_percent = (short) (critSkill.getEffect(critlevel).getX()
                            * critSkill.getEffect(critlevel).getDamage() + added_sharpeye_dmg + 100);
    ...
    public float calculateMaxBaseDamage(int watk, final int matk) {
        ...
        if (watk == 0) {
            ...
            switch (weapon) {
                ...
                default: {
                    if ((job >= 200 && job <= 232) || (job >= 1200 && job <= 1211
                            && (weapon == MapleWeaponType.WAND || weapon == MapleWeaponType.STAFF))) {
