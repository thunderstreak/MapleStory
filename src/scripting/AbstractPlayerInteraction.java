...
public abstract class AbstractPlayerInteraction {
        ...
        for (int i = 0; i < quantity; ++i) {
            ...
            if (mob == null || !mob.getStats().isChangeable()) {
                if (this.c.getPlayer().isAdmin()) {
                    this.c.getPlayer().dropMessage(6,
                            "[系统提示] spawnMobLevel召唤怪物出错，ID为: " + mobId + " 怪物不存在或者该怪物无法使用这个函数来改变怪物的属性！");
                }
            } else {
    ...
    public void spawnMobStats(final int mobId, final int quantity, final long newhp, final int newExp, final int x,
            final int y) {
    ...
    public void spawnMobStats(final int mobId, final int quantity, final long newhp, final int newExp,
        ...
        for (int i = 0; i < quantity; ++i) {
            ...
            if (mob == null) {
                ...
                final OverrideMonsterStats overrideStats = new OverrideMonsterStats(newhp, mob.getMobMaxMp(),
                        (newExp <= 0) ? mob.getMobExp() : newExp, false);
    ...
    public void spawnMobMultipler(final int mobId, final int quantity, final int multipler, final Point pos) {
        for (int i = 0; i < quantity; ++i) {
            ...
            if (mob == null) {
                ...
                final OverrideMonsterStats overrideStats = new OverrideMonsterStats(mob.getMobMaxHp() * multipler,
                        mob.getMobMaxMp() * multipler, mob.getMobExp() + multipler * 100, false);
                mob.setOverrideStats(overrideStats);
                this.c.getPlayer().getMap().spawnMonsterOnGroundBelow(mob, pos);
            }
        }
    ...
    public void spawnMob_map(final int id, final int mapid, final Point pos) {
        this.c.getChannelServer().getMapFactory().getMap(mapid)
    ...
    public void gainItem(final int id, final short quantity, final boolean randomStats, final long period,
            final int slots) {
        this.gainItem(id, quantity, randomStats, period, slots, "", (byte) 0);
    }

    public void gainItem(final int id, final short quantity, final boolean randomStats, final long period,
            final int slots, final String owner, final byte Flag) {
        this.gainItem(id, quantity, randomStats, period, slots, owner, this.c, Flag);
    }

    public void gainItem(final int id, final short quantity, final boolean randomStats, final long period,
            final int slots, final String owner, final MapleClient cg, final byte Flag) {
        if (quantity >= 0) {
    ...
    public void gainItem(final int id, final int str, final int dex, final int luk, final int Int, final int watk,
            final int matk) {
        this.gainItem(id, str, dex, luk, Int, 0, 0, watk, matk, 0, 0, 0, 0, 0, 0);
    }

    public void gainItem(final int id, final int str, final int dex, final int luk, final int Int, final int hp,
            final int mp, final int watk, final int matk, final int wdef, final int mdef, final int hb, final int mz,
            final int ty, final int yd) {
        this.gainItemS(id, str, dex, luk, Int, hp, mp, watk, matk, wdef, mdef, hb, mz, ty, yd, this.c, 0L);
    }

    public void gainItem(final int id, final int str, final int dex, final int luk, final int Int, final int hp,
            final int mp, final int watk, final int matk, final int wdef, final int mdef, final int hb, final int mz,
            final int ty, final int yd, final long time) {
        this.gainItemS(id, str, dex, luk, Int, hp, mp, watk, matk, wdef, mdef, hb, mz, ty, yd, this.c, time);
    }

    public void gainItemS(final int id, final int str, final int dex, final int luk, final int Int, final int hp,
            final int mp, final int watk, final int matk, final int wdef, final int mdef, final int hb, final int mz,
            final int ty, final int yd, final MapleClient cg, final long time) {
        final MapleItemInformationProvider ii = MapleItemInformationProvider.getInstance();
        final MapleInventoryType type = GameConstants.getInventoryType(id);
    ...
    public void gainItem(final int id, final int str, final int dex, final int luk, final int Int, final int watk,
            final int matk, final int suo) {
        this.给予道具(id, str, dex, luk, Int, 0, 0, watk, matk, 0, 0, 0, 0, 0, 0, this.c, 0, 0, 0, 0, suo);
    }

    public void 给予道具(final int id, final int str, final int dex, final int luk, final int Int, final int hp,
            final int mp, final int watk, final int matk, final int wdef, final int mdef, final int hb, final int mz,
            final int ty, final int yd, final int ksjcs, final int ysjcs, final int jcz, final int suo) {
        this.给予道具(id, str, dex, luk, Int, hp, mp, watk, matk, wdef, mdef, hb, mz, ty, yd, this.c, 0, ksjcs, ysjcs, jcz,
                suo);
    }

    public void 给予道具(final int id, final int str, final int dex, final int luk, final int Int, final int hp,
            final int mp, final int watk, final int matk, final int wdef, final int mdef, final int hb, final int mz,
            final int ty, final int yd, final int time, final int ksjcs, final int ysjcs, final int jcz,
            final int suo) {
        this.给予道具(id, str, dex, luk, Int, hp, mp, watk, matk, wdef, mdef, hb, mz, ty, yd, this.c, time, ksjcs, ysjcs,
                jcz, suo);
    }

    public void 给予道具(final int id, final int str, final int dex, final int luk, final int Int, final int hp,
            final int mp, final int watk, final int matk, final int wdef, final int mdef, final int hb, final int mz,
            final int ty, final int yd, final MapleClient cg, final int time, final int ksjcs, final int ysjcs,
            final int jcz, final int suo) {
        final MapleItemInformationProvider ii = MapleItemInformationProvider.getInstance();
        final MapleInventoryType type = GameConstants.getInventoryType(id);
        if (!MapleInventoryManipulator.checkSpace(cg, id, 1, "")) {
            return;
    ...
    public boolean transferCashEquipStat(final short fromSlot, final short toSlot) {
        ...
        this.c.getSession().write(MaplePacketCreator.updateSpecialItemUse_(toEquip,
                GameConstants.getInventoryType(toEquip.getItemId()).getType()));
    ...
    public void givePartyExp_PQ(final int maxLevel, final double mod) {
        if (this.getPlayer().getParty() == null || this.getPlayer().getParty().getMembers().size() == 1) {
            final int amount = (int) Math
                    .round(GameConstants
                            .getExpNeededForLevel((this.getPlayer().getLevel() > maxLevel)
                                    ? (maxLevel + this.getPlayer().getLevel() / 10)
                                    : this.getPlayer().getLevel())
                            / (Math.min(this.getPlayer().getLevel(), maxLevel) / 10.0) / mod);
            this.gainExp(amount);
            return;
        }
        ...
        for (final MaplePartyCharacter chr : this.getPlayer().getParty().getMembers()) {
            ...
            if (curChar != null && (curChar.getMapId() == cMap
                ...
                final int amount2 = (int) Math.round(GameConstants.getExpNeededForLevel(
        ...
        for (final MaplePartyCharacter chr : this.getPlayer().getParty().getMembers()) {
            ...
            if (curChar != null) {
                if (chr.equals(this.getPlayer().getParty().getLeader())) {
                    ...
                    this.gainItem(id, (short) (removeAll ? (-curChar.itemQuantity(id)) : (quantity * 2)), false, 0L, 0,
    ...
    public void gainCloseness(final int closeness, final int index) {
        ...
        if (pet != null) {
            ...
            this.getClient().getSession().write(PetPacket.updatePet(pet,
                    this.getPlayer().getInventory(MapleInventoryType.CASH).getItem((byte) pet.getInventoryPosition()),
                    true));
        }
    }
    ...
    public void gainClosenessAll(final int closeness) {
        for (final MaplePet pet : this.getPlayer().getPets()) {
            if (pet != null) {
                pet.setCloseness(pet.getCloseness() + closeness);
                this.getClient().getSession().write(PetPacket.updatePet(pet, this.getPlayer()
                        .getInventory(MapleInventoryType.CASH).getItem((byte) pet.getInventoryPosition()), true));
            }
        }
    }
    ...
    public void gainPet(int id, String name, int level, int closeness, int fullness, final long period) {
        ...
        try {
            MapleInventoryManipulator.addById(
                    this.c, id, (short) 1, "", MaplePet.createPet(id, name, level, closeness, fullness,
                            MapleInventoryIdentifier.getInstance(), (id == 5000054) ? ((int) period) : 0),
                    period, (byte) 0);
    ...
    public boolean beibao(final int A) {
        return (this.c.getPlayer().getInventory(MapleInventoryType.EQUIP).getNextFreeSlot() > -1 && A == 1)
                || (this.c.getPlayer().getInventory(MapleInventoryType.USE).getNextFreeSlot() > -1 && A == 2)
                || (this.c.getPlayer().getInventory(MapleInventoryType.SETUP).getNextFreeSlot() > -1 && A == 3)
                || (this.c.getPlayer().getInventory(MapleInventoryType.ETC).getNextFreeSlot() > -1 && A == 4)
                || (this.c.getPlayer().getInventory(MapleInventoryType.CASH).getNextFreeSlot() > -1 && A == 5);
    }
    ...
    public boolean beibao(final int A, final int kw) {
        return (this.c.getPlayer().getInventory(MapleInventoryType.EQUIP).getNextFreeSlot() > kw && A == 1)
                || (this.c.getPlayer().getInventory(MapleInventoryType.USE).getNextFreeSlot() > kw && A == 2)
                || (this.c.getPlayer().getInventory(MapleInventoryType.SETUP).getNextFreeSlot() > kw && A == 3)
                || (this.c.getPlayer().getInventory(MapleInventoryType.ETC).getNextFreeSlot() > kw && A == 4)
                || (this.c.getPlayer().getInventory(MapleInventoryType.CASH).getNextFreeSlot() > kw && A == 5);
    }
    ...
    public void resetAp() {
        final boolean beginner = this.getPlayer().getJob() == 0 || this.getPlayer().getJob() == 1000
                || this.getPlayer().getJob() == 2001;
    ...
    public int MarrageChecking() {
        ...
        if (this.getPlayer().getGender() == 0 && !this.getPlayer().haveItem(1050121)
                && !this.getPlayer().haveItem(1050122) && !this.getPlayer().haveItem(1050113)) {
            return 5;
        }
        if (this.getPlayer().getGender() == 1 && !this.getPlayer().haveItem(1051129)
                && !this.getPlayer().haveItem(1051130) && !this.getPlayer().haveItem(1051114)) {
            return 5;
        }
