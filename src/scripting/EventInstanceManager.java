...
public class EventInstanceManager {
    ...
    public void registerPlayer(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Event name" + this.em.getName() + ", Instance name : "
                    + this.name + ", method Name : playerEntry:\n" + ex2);
            System.out.println("Event name" + this.em.getName() + ", Instance name : " + this.name
    ...
    public void changedMap(final MapleCharacter chr, final int mapid) {
        ...
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                    "副本名称" + this.em.getName() + ", 实例名称 : " + this.name + ", 方法名称 : changedMap:\n" + ex);
            System.out.println("Event name" + this.em.getName() + ", Instance name : " + this.name
        ...
        this.eventTimer = Timer.EventTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                            "Event name" + EventInstanceManager.this.em.getName() + ", Instance name : "
                                    + EventInstanceManager.this.name + ", method Name : scheduledTimeout:\n" + ex);
                    System.out.println("Event name" + EventInstanceManager.this.em.getName() + ", Instance name : "
                            + EventInstanceManager.this.name + ", method Name : scheduledTimeout:\n" + ex);
                }
            }
        }, delay);
    ...
    public void unregisterMonster(final MapleMonster mob) {
        ...
        if (this.mobs.size() == 0) {
            try {
                ...
                FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Event name" + this.em.getName() + ", Instance name : "
                        + this.name + ", method Name : allMonstersDead:\n" + ex);
                System.out.println("Event name" + this.em.getName() + ", Instance name : " + this.name
    ...
    public void playerKilled(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Event name" + this.em.getName() + ", Instance name : "
                    + this.name + ", method Name : playerDead:\n" + ex);
            System.out.println("Event name" + this.em.getName() + ", Instance name : " + this.name
    ...
    public boolean revivePlayer(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Event name" + this.em.getName() + ", Instance name : "
                    + this.name + ", method Name : playerRevive:\n" + ex);
            System.out.println("Event name" + this.em.getName() + ", Instance name : " + this.name
    ...
    public void monsterKilled(final MapleCharacter chr, final MapleMonster mob) {
        ...
        try {
            ...
            if (chr.getCarnivalParty() != null && (mob.getStats().getPoint() > 0 || mob.getStats().getCP() > 0)) {
                this.em.getIv().invokeFunction("monsterKilled", this, chr,
                        (mob.getStats().getCP() > 0) ? mob.getStats().getCP() : mob.getStats().getPoint());
            }
        } catch (ScriptException ex) {
            System.out.println("Event name" + ((this.em == null) ? "null" : this.em.getName()) + ", Instance name : "
                    + this.name + ", method Name : monsterValue:\n" + ex);
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                    "Event name" + ((this.em == null) ? "null" : this.em.getName()) + ", Instance name : " + this.name
    ...
    public void dispose_NoLock() {
        ...
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                    "Event name" + emN + ", Instance name : " + this.name + ", method Name : dispose:\n" + e);
        }
    }
        ...
        Timer.EventTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    System.out.println("Event name" + EventInstanceManager.this.em.getName() + ", Instance name : "
                            + EventInstanceManager.this.name + ", method Name : " + methodName + ":\n" + ex);
                    FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                            "Event name" + EventInstanceManager.this.em.getName() + ", Instance name : "
                                    + EventInstanceManager.this.name + ", method Name(schedule) : " + methodName
                                    + " :\n" + ex);
                }
            }
        }, delay);
    ...
    public final void leftParty(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Event name" + this.em.getName() + ", Instance name : "
                    + this.name + ", method Name : leftParty:\n" + ex);
        }
    }
    ...
    public final void disbandParty() {
        ...
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Event name" + this.em.getName() + ", Instance name : "
                    + this.name + ", method Name : disbandParty:\n" + ex);
        }
    }
    ...
    public final void removePlayer(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Event name" + this.em.getName() + ", Instance name : "
                    + this.name + ", method Name : playerExit:\n" + ex);
        }
    }
    ...
    public final void registerCarnivalParty(final MapleCharacter leader, final MapleMap map, final byte team) {
        ...
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Event name" + this.em.getName() + ", Instance name : "
                    + this.name + ", method Name : registerCarnivalParty:\n" + ex);
        } catch (NoSuchMethodException ex2) {
        }
    }
    ...
    public void onMapLoad(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Event name" + this.em.getName() + ", Instance name : "
                    + this.name + ", method Name : onMapLoad:\n" + ex);
        } catch (NoSuchMethodException ex2) {
        }
    }
