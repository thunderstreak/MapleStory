...
public class EventManager {
    ...
    public void cancel() {
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                    "Event name : " + this.name + ", method Name : cancelSchedule:\n" + ex);
        }
    }
    ...
    public void disposeInstance(final String name) {
        ...
        if (this.getProperty("leader") != null && this.instances.size() == 0
                && this.getProperty("leader").equals("false")) {
    ...
    public void startInstance() {
        try {
            ...
            ex.printStackTrace();
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                    "Event name : " + this.name + ", method Name : setup:\n" + ex);
        }
    }
    ...
    public void startInstance(final MapleCharacter character, final String leader) {
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                    "Event name : " + this.name + ", method Name : setup-Guild:\n" + ex);
        }
    }
    ...
    public void startInstance_CharID(final MapleCharacter character) {
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                    "Event name : " + this.name + ", method Name : setup-CharID:\n" + ex);
        }
    }
    ...
    public void startInstance(final MapleCharacter character) {
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                    "Event name : " + this.name + ", method Name : setup-character:\n" + ex);
        }
    }
    ...
    public void startInstance(final MapleParty party, final MapleMap map) {
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                    "Event name : " + this.name + ", method Name : setup-partyid:\n" + ex);
        } catch (Exception ex2) {
    ...
    public void startInstance_NoID(final MapleParty party, final MapleMap map, final Exception old) {
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Event name : " + this.name
    ...
    public void startInstance(final EventInstanceManager eim, final String leader) {
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                    "Event name : " + this.name + ", method Name : setup-leader:\n" + ex);
        }
    }
    ...
    public void startInstance(final MapleSquad squad, final MapleMap map, final int questID) {
        ...
        try {
            ...
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log,
                    "Event name : " + this.name + ", method Name : setup-squad:\n" + ex);
        }
    }
    ...
    public void startInstance(final MapleSquad squad, final MapleMap map, final String bossid) {
        ...
        if (!squad.getLeader().isGM()) {
            ...
            if (chrSize < squad.getType().i) {
                squad.getLeader().dropMessage(5,
                        "远征队中人员少于 " + squad.getType().i + " 人，无法开始远征任务。注意必须队伍中的角色在线且在同一地图。当前人数: " + chrSize);
                return;
            }
            if (this.name.equals("CWKPQ") && squad.getJobs().size() < 5) {
        ...
        try {
            ...
            System.out.println("Event name : " + this.name + ", method Name : setup-squad:\n" + ex);
            FileoutputUtil.log("logs/Script_Except.log",
                    "Event name : " + this.name + ", method Name : setup-squad:\n" + ex);
        }
    }
