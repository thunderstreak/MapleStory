...
public class ChannelServer implements Serializable {
    ...
    public static Collection<ChannelServer> getAllInstances() {
        return Collections
                .unmodifiableCollection((Collection<? extends ChannelServer>) ChannelServer.instances.values());
    }
    ...
    private ChannelServer(final int channel) {
        ...
        this.mapleSquads = new ConcurrentEnumMap<MapleSquad.MapleSquadType, MapleSquad>(
                MapleSquad.MapleSquadType.class);
    ...
    public void run_startup_configurations() {
        ...
        try {
            ...
            this.port = Short.parseShort(
                    ServerProperties.getProperty("RoyMS.Port" + this.channel, String.valueOf(2524 + this.channel)));
    ...
    public Map<MapleSquad.MapleSquadType, MapleSquad> getAllSquads() {
        return Collections
                .unmodifiableMap((Map<? extends MapleSquad.MapleSquadType, ? extends MapleSquad>) this.mapleSquads);
    }
    ...
    public void closeAllMerchants() {
        ...
        System.out.println(
                "频道 " + this.channel + " 共保存雇佣商店: " + ret + " | 耗时: " + (System.currentTimeMillis() - Start) + " 毫秒.");
    }
