...
public class MapleGuildRanking {
    ...
    private void showLevelRank() {
        ...
        try {
            ...
            final ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                final levelRankingInfo rank1 = new levelRankingInfo(rs.getString("name"), rs.getInt("level"),
    ...
    private void showMesoRank() {
        ...
        try (final PreparedStatement ps = con.prepareStatement(
            ...
            final ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                final mesoRankingInfo rank2 = new mesoRankingInfo(rs.getString("name"), rs.getLong("money"),
                        rs.getInt("str"), rs.getInt("dex"), rs.getInt("int"), rs.getInt("luk"));
    ...
    public static class mesoRankingInfo {
        ...
        public mesoRankingInfo(final String name, final long meso, final int str, final int dex, final int intt,
                final int luk) {
            this.name = name;
            this.meso = meso;
            this.str = str;
    ...
    public static class levelRankingInfo {
        ...
        public levelRankingInfo(final String name, final int level, final int str, final int dex, final int intt,
                final int luk) {
            this.name = name;
            this.level = level;
            this.str = str;
    ...
    public static class GuildRankingInfo {
        ...
        public GuildRankingInfo(final String name, final int gp, final int logo, final int logocolor, final int logobg,
