...
public class MapleFamilyCharacter implements Serializable {
    ...
    public MapleFamilyCharacter(final int _id, final int _lv, final String _name, final int _channel, final int _job,
            final int _fid, final int _sid, final int _jr1, final int _jr2, final int _crep, final int _trep,
            final boolean _on) {
        this.channel = -1;
        this.pedigree = new ArrayList<Integer>();
        this.descendants = 0;
