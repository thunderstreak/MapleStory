...
public abstract class Timer {
    ...
    public ScheduledFuture<?> register(final Runnable r, final long repeatTime, final long delay) {
        ...
        return this.ses.scheduleAtFixedRate(new LoggingSaveRunnable(r, this.file), delay, repeatTime,
    ...
    public ScheduledFuture<?> register(final Runnable r, final long repeatTime) {
        ...
        return this.ses.scheduleAtFixedRate(new LoggingSaveRunnable(r, this.file), 0L, repeatTime,
                TimeUnit.MILLISECONDS);
    }
