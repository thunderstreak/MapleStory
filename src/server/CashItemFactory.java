...
public class CashItemFactory {
    ...
    protected CashItemFactory() {
        ...
        this.itemStringInfo = MapleDataProviderFactory
    ...
    public void initialize() {
        ...
        for (final MapleData field : this.data.getData("Commodity.img").getChildren()) {
            ...
            final CashItemInfo stats = new CashItemInfo(MapleDataTool.getIntConvert("ItemId", field, 0),
                    MapleDataTool.getIntConvert("Count", field, 1), MapleDataTool.getIntConvert("Price", field, 0), SN,
        ...
        try {
            ...
            try (final PreparedStatement ps = con.prepareStatement("SELECT * FROM cashshop_modified_items");
                ...
                while (rs.next()) {
                    final CashItemInfo.CashModInfo ret = new CashItemInfo.CashModInfo(rs.getInt("serial"),
                            rs.getInt("discount_price"), rs.getInt("mark"), rs.getInt("showup") > 0,
                            rs.getInt("itemid"), rs.getInt("priority"), rs.getInt("package") > 0, rs.getInt("period"),
