...
public class MapleLifeFactory {
    ...
    public static MapleMonster getMonster(final int mid) {
        ...
        if (stats == null) {
            MapleData monsterData = MapleLifeFactory.data
                    .getData(StringUtil.getLeftPaddedStr(Integer.toString(mid) + ".img", '0', 11));
            if (monsterData == null) {
                return null;
            }
            ...
            if (monsterSkillData != null) {
                ...
                while (monsterSkillData.getChildByPath(Integer.toString(i)) != null) {
                    skills.add(new Pair<Integer, Integer>(MapleDataTool.getInt(i + "/skill", monsterSkillData, 0),
