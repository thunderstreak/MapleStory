...
public class MobSkillFactory {
    ...
    public static MobSkill getMobSkill(final int skillId, final int level) {
        ...
        if (MobSkillFactory.skillRoot == null || MobSkillFactory.skillRoot.getChildren() == null
                || MobSkillFactory.skillRoot.getChildByPath(String.valueOf(skillId)) == null
                || MobSkillFactory.skillRoot.getChildByPath(String.valueOf(skillId)).getChildren() == null
                || MobSkillFactory.skillRoot.getChildByPath(String.valueOf(skillId)).getChildByPath("level") == null) {
            return null;
        }
