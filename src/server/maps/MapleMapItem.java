...
public class MapleMapItem extends AbstractMapleMapObject {
    ...
    public MapleMapItem(final IItem item, final Point position, final MapleMapObject dropper,
            final MapleCharacter owner, final byte type, final boolean playerDrop) {
        this.meso = 0;
        this.questid = -1;
        this.pickedUp = false;
        this.randDrop = false;
    ...
    public MapleMapItem(final IItem item, final Point position, final MapleMapObject dropper,
            final MapleCharacter owner, final byte type, final boolean playerDrop, final int questid) {
        this.meso = 0;
        this.questid = -1;
        this.pickedUp = false;
        this.randDrop = false;
    ...
    public MapleMapItem(final int meso, final Point position, final MapleMapObject dropper, final MapleCharacter owner,
            final byte type, final boolean playerDrop) {
        this.meso = 0;
        this.questid = -1;
        this.pickedUp = false;
        this.randDrop = false;
    ...
    public void sendSpawnData(final MapleClient client) {
        if (this.questid <= 0 || client.getPlayer().getQuestStatus(this.questid) == 1) {
            client.getSession()
                    .write((Object) MaplePacketCreator.dropItemFromMapObject(this, null, this.getPosition(), (byte) 2));
        }
    }
