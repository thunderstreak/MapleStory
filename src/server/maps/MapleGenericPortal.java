    ...
    public void enterPortal(final MapleClient c) {
        ...
        if (this.portalState || c.getPlayer().isGM()) {
            if (this.getScriptName() != null) {
                ...
                final MapleMap to = ChannelServer.getInstance(c.getChannel()).getMapFactory()
                        .getMap(this.getTargetMapId());
                if (!c.getPlayer().isGM()) {
                    if (to == null) {
                ...
                c.getPlayer().changeMapPortal(to,
                        (to.getPortal(this.getTarget()) == null) ? to.getPortal(0) : to.getPortal(this.getTarget()));
            }
        }
