...
public class AramiaFireWorks {
    ...
    private void broadcastServer(final MapleCharacter c, final int itemid) {
        World.Broadcast.broadcastMessage(MaplePacketCreator
                .serverNotice(6, itemid, "<頻道 " + c.getClient().getChannel() + "> 弓箭手村邱比特公園即將開始發射煙火!").getBytes());
    }
    ...
    static {
        ...
        array_Y = new int[] { 1234, 1234, 1174, 1234, 1174, 1174, 1174, 1260, 1234, 1234, 1234, 1234, 1234, 1114, 1114,
                1140 };
    }
}
