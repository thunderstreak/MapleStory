...
public class MapleDoor extends AbstractMapleMapObject {
    ...
    private MaplePortal getFreePortal() {
        ...
        for (final MapleMapObject obj : this.town.getAllDoorsThreadsafe()) {
            ...
            if (door.getOwner() != null && door.getOwner().getParty() != null && this.getOwner() != null
                    && this.getOwner().getParty() != null
                    && this.getOwner().getParty().getMemberById(door.getOwnerId()) != null) {
    ...
    public void sendSpawnData(final MapleClient client) {
        ...
        if (this.target.getId() == client.getPlayer().getMapId() || this.getOwnerId() == client.getPlayer().getId()
                || (this.getOwner() != null && this.getOwner().getParty() != null
                        && this.getOwner().getParty().getMemberById(client.getPlayer().getId()) != null)) {
            client.getSession()
                    .write(MaplePacketCreator.spawnDoor(this.getOwnerId(),
                            (this.town.getId() == client.getPlayer().getMapId()) ? this.townPortal.getPosition()
                                    : this.targetPosition,
                            true));
            if (this.getOwner() != null && this.getOwner().getParty() != null
                    && (this.getOwnerId() == client.getPlayer().getId()
                            || this.getOwner().getParty().getMemberById(client.getPlayer().getId()) != null)) {
                client.getSession().write(MaplePacketCreator.partyPortal(this.town.getId(), this.target.getId(),
                        this.skillId, this.targetPosition));
            }
            client.getSession().write(MaplePacketCreator.spawnPortal(this.town.getId(), this.target.getId(),
                    this.skillId, this.targetPosition));
        }
    }
    ...
    public void sendDestroyData(final MapleClient client) {
        ...
        if (this.target.getId() == client.getPlayer().getMapId() || this.getOwnerId() == client.getPlayer().getId()
                || (this.getOwner() != null && this.getOwner().getParty() != null
                        && this.getOwner().getParty().getMemberById(client.getPlayer().getId()) != null)) {
            if (this.getOwner().getParty() != null && (this.getOwnerId() == client.getPlayer().getId()
                    || this.getOwner().getParty().getMemberById(client.getPlayer().getId()) != null)) {
    ...
    public void warp(final MapleCharacter chr, final boolean toTown) {
        if (chr.getId() == this.getOwnerId() || (this.getOwner() != null && this.getOwner().getParty() != null
                && this.getOwner().getParty().getMemberById(chr.getId()) != null)) {
            if (!toTown) {
