...
public class CashItemInfo {
    ...
    public CashItemInfo(final int itemId, final int count, final int price, final int sn, final int expire,
            final int gender, final boolean sale) {
        this.itemId = itemId;
        this.count = count;
        this.price = price;
        this.sn = sn;
    ...
    public boolean onSale() {
        return this.onSale || (CashItemFactory.getInstance().getModInfo(this.sn) != null
                && CashItemFactory.getInstance().getModInfo(this.sn).showUp);
    }
    ...
    public static class CashModInfo {
        ...
        public CashModInfo(final int sn, final int discount, final int mark, final boolean show, final int itemid,
                final int priority, final boolean packagez, final int period, final int gender, final int count,
                final int meso, final int unk_1, final int unk_2, final int unk_3, final int extra_flags) {
            this.sn = sn;
            this.itemid = itemid;
