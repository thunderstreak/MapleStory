...
public class SpeedRunner {
    ...
    public void loadSpeedRunData(final SpeedRunType type) throws SQLException {
        ...
        final StringBuilder ret = new StringBuilder(
                "#rThese are the speedrun times for " + StringUtil.makeEnumHumanReadable(type.name()) + ".#k\r\n\r\n");
        final Map<Integer, String> rett = new LinkedHashMap<Integer, String>();
        final ResultSet rs = ps.executeQuery();
        int rank = 1;
        boolean changed;
        for (boolean cont = changed = rs.first(); cont; cont = rs.next()) {
            this.addSpeedRunData(ret, rett, rs.getString("members"), rs.getString("leader"), rank,
    ...
    public Pair<StringBuilder, Map<Integer, String>> addSpeedRunData(final StringBuilder ret,
            final Map<Integer, String> rett, final String members, final String leader, final int rank,
