...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    cm.sendNext(
      'Magicians are armed with flashy element-based spells and secondary magic that aids party as a whole. After the 2nd job adv., the elemental-based magic will provide ample amount of damage to enemies of opposite element.'
    );
  } else if (status == 1) {
