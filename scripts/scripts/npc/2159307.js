...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    ...
    cm.sendNextNoESC(
      'Things are strange these days. Arkarium has it for you, since you were the one who managed to catch the Goddess of the Temple of Time. He only managed to blind her, but he still thinks he deserves all the credit...Fool.'
    );
  } else if (status == 2) {
    cm.sendDirectionStatus(3, 2);
    cm.sendNextNoESC(
      "...Are you okay? You seem different... Yeah, you are. You used to scold me when I asked you such things, but now... Hey, you don't look so good. Did something happen? Are you hurt?"
    );
  } else if (status == 3) {
