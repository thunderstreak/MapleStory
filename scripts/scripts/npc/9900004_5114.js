  ...
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      if (beauty == 0) {
        ...
        if (
          cm.haveItem(4250802, selection * 1) &&
          cm.haveItem(4251102, selection * 1) &&
          cm.haveItem(4250902, selection * 1) &&
          cm.haveItem(4251002, selection * 1) &&
          cm.getPlayer().getMeso() > selection * 200000
        ) {
