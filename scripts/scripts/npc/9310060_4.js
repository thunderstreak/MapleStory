...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      //帽子
      if (
        cm.haveItem(4000120, 200) &&
        cm.haveItem(4000117, 200) &&
        cm.haveItem(4000121, 200) &&
        cm.haveItem(4000122, 200) &&
        cm.haveItem(4000118, 200) &&
        cm.haveItem(4000119, 200) &&
        cm.haveItem(4000126, 50) &&
      ...
      //帽子
      if (
        cm.haveItem(4004000, 30) &&
        cm.haveItem(4004001, 30) &&
        cm.haveItem(4004002, 30) &&
        cm.haveItem(4004003, 30) &&
        cm.haveItem(4000463, 2) &&
        cm.haveItem(1012187, 1) &&
        cm.getMeso() > 10000000
      ) {
      ...
      //套装
      if (
        cm.haveItem(4011000, 20) &&
        cm.haveItem(4011001, 20) &&
        cm.haveItem(4011002, 20) &&
        cm.haveItem(4011003, 20) &&
        cm.haveItem(4011004, 20) &&
        cm.haveItem(4011005, 20) &&
        cm.haveItem(4011006, 20) &&
        cm.haveItem(4000463, 3) &&
        cm.haveItem(1012188, 1) &&
        cm.getMeso() > 20000000
      ) {
      ...
      //手套
      if (
        cm.haveItem(4021000, 20) &&
        cm.haveItem(4021001, 20) &&
        cm.haveItem(4021002, 20) &&
        cm.haveItem(4021003, 20) &&
        cm.haveItem(4021004, 20) &&
        cm.haveItem(4021005, 20) &&
        cm.haveItem(4021006, 20) &&
        cm.haveItem(4021007, 10) &&
        cm.haveItem(4021008, 50) &&
        cm.haveItem(4000463, 5) &&
        cm.haveItem(1012189, 1) &&
        cm.getMeso() > 30000000
      ) {
