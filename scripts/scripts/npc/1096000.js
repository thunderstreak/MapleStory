...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    ...
    cm.sendNextNoESC(
      "It sure does! Maple Island is a great place to train, since there are no dangerous monsters there. Plus, you'll make plenty of friends and learn the basics. When you're ready, there's a big, wide world out there for you to explore!"
    );
  } else if (status == 3) {
