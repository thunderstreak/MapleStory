  ...
  if (cm.getMapId() == 20000) {
    ...
    switch (selection) {
      ...
      case 2:
        ...
        cm.sendOk(
          '#e#bfalse = 未达到 true = 已达到#k\r\n\r\n#v4001078#  x 200 = #r' +
            cm.haveItem(4001078, 200) +
            '#k\r\n#v4000235##  x 50 = #r' +
            cm.haveItem(4000235, 50) +
            '#k\r\n#v4000262#  x 200 = #r' +
            cm.haveItem(4000262, 200) +
            '#k\r\n#v4000263#  x 200 = #r' +
            cm.haveItem(4000263, 200) +
            '#k\r\n#v4000030#  x 200 = #r' +
            cm.haveItem(4000030, 200) +
            '#k\r\n#v4000268#  x 200 = #r' +
            cm.haveItem(4000268, 200) +
            '#k\r\n#v4000269#  x 200 = #r' +
            cm.haveItem(4000269, 200) +
            '#k\r\n熟练度相差;' +
            (1999 - sld) +
            ''
        );
