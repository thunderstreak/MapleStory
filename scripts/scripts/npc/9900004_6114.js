  ...
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      if (
        ...
        cm.haveItem(1113072, 1) &&
        cm.haveItem(4031558, 60) &&
        cm.haveItem(4002002, 60) &&
        cm.haveItem(4000244, 10) &&
        cm.haveItem(4000245, 10) &&
        cm.getMeso() >= 20000000
      ) {
      ...
      if (
        ...
        cm.haveItem(1113073, 1) &&
        cm.haveItem(4031558, 80) &&
        cm.haveItem(4002002, 80) &&
        cm.haveItem(4000244, 15) &&
        cm.haveItem(4000245, 15) &&
        cm.getMeso() >= 30000000
      ) {
      ...
      if (
        ...
        cm.haveItem(1113074, 1) &&
        cm.haveItem(4031558, 100) &&
        cm.haveItem(4002002, 100) &&
        cm.haveItem(4000244, 20) &&
        cm.haveItem(4000245, 20) &&
        cm.getMeso() >= 50000000
      ) {
