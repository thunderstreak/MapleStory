...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      if (
        cm.haveItem(4001266, 10) &&
        cm.haveItem(4002000, 50) &&
        cm.haveItem(4002001, 50) &&
        cm.haveItem(4002002, 50) &&
        cm.haveItem(4002003, 50) &&
        cm.haveItem(4031559, 10) &&
      ...
      if (
        cm.haveItem(4000313, 1000) &&
        cm.haveItem(4000243, 5) &&
        cm.haveItem(4000235, 5) &&
        cm.haveItem(4031559, 50) &&
        cm.haveItem(4031558, 20) &&
      ...
      if (
        cm.haveItem(4001266, 20) &&
        cm.haveItem(4000313, 2000) &&
        cm.haveItem(4000244, 5) &&
        cm.haveItem(4000245, 5) &&
      ...
      if (
        ...
        cm.haveItem(1002927, 1) &&
        cm.haveItem(1002926, 1) &&
        cm.haveItem(4031196, 20) &&
        cm.haveItem(4000463, 20) &&
        cm.haveItem(1012190, 1) &&
        cm.getMeso() >= 40000000
      ) {
