...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    cm.sendSimple(
      '嗨， #r#h ##k! 我的名字是 #r#p9000039##k. 如果你有 #b赞助点数#k. 可以找我换东西哦。 好了你需要什么？？\r\n#b#L0#什么是赞助点数？#l\r\n#b#L1#换一些赞助商品#l \r\n#b#L2#换一些椅子#l \r\n#b#L3#换一些名声#l\r\n#L4#换一些点数#l\r\n#L6#我目前有多少赞助点数?\r\n#L5#红色福袋换1千赞助点#l \r\n#L7#1千赞助点换红色福袋#l#k'
    );
  } else if (status == 1) {
    sel = selection;
    if (selection == 0) {
      ...
      for (var i = 0; i < items.length; i++) {
        selStr +=
          ...
          items[i] +
          '#' +
          (itemsu[i] > 0 ? '(附赠 ' + itemsu[i] + ' 卷)' : '') +
          ' x ' +
          itemsq[i] +
          ' 为 #e' +
          itemsp[i] +
          '#n 赞助点#n' +
          (itemse[i] > 0 ? ' ...期限 #r#e' + itemse[i] + '#n#b天' : '') +
          '#l\r\n';
      }
      ...
      if (!cm.getPlayer().haveItem(3993003)) {
        ...
        cm.sendGetNumber(
          '你想要用多少#r#t3993003##k换赞助点数？？ \r\n比值: (1 #t3993003# = 1000 赞助点) \r\n(目前你有: ' +
            cm.getPlayer().itemQuantity(3993003) +
            '个 #r#t3993003##k) \r\n(目前你有: ' +
