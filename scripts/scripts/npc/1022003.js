  ...
  if (status == 0 && mode == 1) {
    ...
    if (selectedType == 0) {
      ...
      var helmets = new Array(
        '蓝色金属头箍#k - 需要等级 Lv. 15#b',
        '黄色金属头箍#k - 需要等级 Lv. 15#b',
        '金属头盔#k - 需要等级 Lv. 10#b',
        '锂矿头盔#k - 需要等级 Lv. 10#b',
        '钢铁帽#k - 需要等级 Lv. 12#b',
        '锂矿帽#k - 需要等级 Lv. 12#b',
        '铁制头具#k - 需要等级 Lv. 15#b',
        '锂矿钢盔#k - 需要等级 Lv. 15#b',
        '钢制海盗帽#k - 需要等级 Lv. 20#b',
        '锂矿海盗头盔#k - 需要等级 Lv. 20#b',
        '钢铁球帽#k - 需要等级 Lv. 20#b',
        '锂矿橄榄球帽#k - 需要等级 Lv. 20#b',
        '锂矿尖头盔#k - 需要等级 Lv. 22#b',
        '黄金尖头盔#k - 需要等级 Lv. 22#b',
        '黄金骑士头盔#k - 需要等级 Lv. 25#b',
        '紫矿骑士头盔#k - 需要等级 Lv. 25#b',
        '红色战斗头盔#k - 需要等级 Lv. 35#b',
        '蓝色战斗头盔#k - 需要等级 Lv. 35#b',
        '锂矿诺曼头盔#k - 需要等级 Lv. 40#b',
        '黄金诺曼头盔#k - 需要等级 Lv. 40#b',
        '锂矿十字军帽#k - 需要等级 Lv. 50#b',
        '银制十字军帽子#k - 需要等级 Lv. 50#b',
        '旧诺曼头盔#k - 需要等级 Lv. 55#b',
        '旧锂矿诺曼头盔#k - 需要等级 Lv. 55#b'
      );
    ...
    if (cm.getMeso() < cost * qty) {
      ...
      if (!complete) cm.sendOk('你给我的材料可能不够哦,再帮我检查一下背包吧~');
      else {
        if (mats instanceof Array) {
          for (var i = 0; i < mats.length; i++) {
