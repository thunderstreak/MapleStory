...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    cm.sendSimple(
      '你有没有听过海滩与所谓的 #b黄金海滩#k, 这个地方在维多利亚呢?? 我可以现在帮助你到那个地方只需要 #b2000#k 枫币 或者如果你有一张 #b#t' +
        ticket +
        '##k 那么就可以免费去..#k\r\n\r\n#L0##b我愿意付 ' +
        pay +
        ' 枫币.#k#l\r\n#L1##b我有 #t' +
    ...
    if (selection == 0 || selection == 1) {
      ...
      cm.sendNext(
        '你一定好奇什么是 #b#t' +
          ticket +
          '##k. 哈哈，这是非常可以理解的。贵宾门票到弗洛里纳海滩是一个项目在哪里，只要你在身上，你可以用自己的方式来弗洛里纳海滩免费。那就是，即使我们不得不买这些，但不幸的是我在我的宝贵的暑假失去了一个雷几周前这样一个难得的道具.'
      );
    }
  } else if (status == 2) {
    if (check == 0) {
