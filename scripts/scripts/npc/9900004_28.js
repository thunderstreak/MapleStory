...
function action(k, e, s) {
  ...
  if (status == 0) {
    ...
    var j =
      '#n-您当前交易点:#r#e ' +
      (auctionPoint == null ? 0 : auctionPoint.getPoint()) +
      '#n#k \r\n-上架: #r' +
      b +
      '#k 下架: #r' +
      c +
      ...
      h +
      '#k  容纳:#r' +
      (character_auctionItems == null ? 0 : character_auctionItems.size()) +
      ' #k/#d ' +
      5 +
      '#k\r\n';
    j += '  #r┏━━━━━━━━━━━━━━━━━━━━━━━┓#k\r\n';
                ...
                if (sel_1 == 2) {
                  ...
                  for (var n = 0; n < character_auctionItems.size(); n++) {
                    ...
                    j +=
                      ...
                      r.getPrice() +
                      ' #b状态:' +
                      (r.getAuctionState().getState() == 0 ? '#k' : r.getAuctionState().getState() == 1 ? '#r' : '#d') +
                      r.getAuctionState() +
                      (r.getAuctionState().getState() == 2 ? '[' + r.getBuyerName() + ']' : '#l') +
                      '\r\n';
                  }
                  cm.sendSimple(j);
                }
          ...
          if (sel_0 == 21) {
            ...
            if (sel_0 == 22) {
              ...
              j +=
                ...
                (r.getAuctionState().getState() == 0 ? '#k' : r.getAuctionState().getState() == 1 ? '#r' : '#d') +
                r.getAuctionState() +
                (r.getAuctionState().getState() == 2 ? '[' + r.getBuyerName() + ']' : '') +
                '\r\n\r\n';
