...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    ...
    cm.sendNextNoESC(
      "We can't stop the curse, but we can outlive it. We should seal Elluel before the curse can spread beyond the village. #bWe Elves should all slumber here, undisturbed.#k Time is on our side and we have nothing to worry about.",
      1033204
    );
  } else if (status == 17) {
