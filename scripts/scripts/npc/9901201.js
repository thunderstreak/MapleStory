...
var nitems = Array(
  '2 million mesos',
  '10k A-Cash',
  '#v2340000#White Scroll',
  '#v2049100#Chaos Scroll x 5',
  '#v5220000#Ga-cha-pon Ticket x 25',
  '#v5050000#AP Reset x 5',
  '#v5062000#Miracle Cube x 4',
  '#v5062000#Miracle Cube x 21'
);
var np = Array(1, 1, 5, 2, 1, 1, 1, 5);
var ditems = Array(
  '#v5211000#2x EXP Card (1 Day)',
  '#v5360017#2x Drop/Meso Card (1 Day)',
  '#v4030005#2x A-Cash Card (1 Day)',
  '#v5650000#Party Bonus Coupon (5 Day)',
  '#v5000057#Pet Kino (7 Day)',
  '#v5000015#Pet Rudolph (7 Day)',
  '#v5451000#Premium Dungeon Card (3-Day)',
  '#v4030004#Clone (1-Day)'
);
var dp = Array(4, 3, 2, 2, 2, 2, 15, 3);
var mitems = Array(
  '#v4080100#Match Cards',
  '#v4080000#Omok',
  '#v4080001#Omok',
  '#v4080002#Omok',
  '#v4080003#Omok',
...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    cm.sendSimple(
      "Hello! I'm the #r#eVoting Point NPC#n#k. If you have voted on our site, you will get a point each time! I see you have #e#r" +
        cm.getPlayer().getVPoints() +
        '#n#k voting points! I can redeem your points for cool things! What would you like...?\r\n\r\n#b#L0#Trade for Normal Stuffs#l\r\n#L1#Trade for Special Items#l\r\n#L2#Trade for Royal Hair(35 vote points)#l\r\n#L3#Trade for Minigame Item#l\r\n#L4#Reset ALL AP (35 vote points)#l#k'
    );
  } else if (status == 1) {
    status += selection;
    var selStr;
    ...
    if (cm.getPlayer().getVPoints() < np[selection]) {
      ...
      switch (selection) {
        case 0:
          if (cm.getPlayer().getMeso() > 2137483647) {
            //integer.max_value - 10m
