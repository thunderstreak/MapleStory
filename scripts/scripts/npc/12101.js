...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    cm.sendNext(
      "This is the town called #bAmherst#k, located at the northeast part of the Maple Island. You know that Maple Island is for beginners, right? I'm glad there are only weak monsters around this place."
    );
  } else if (status == 1) {
    cm.sendNextPrev(
