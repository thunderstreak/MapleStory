...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    cm.sendNext(
      'The experiment is going well, quite well. The endless supply of Rue is certainly speeding things along. Joining the Black Wings was a wise decision, a wise decision indeed. Muahaha!'
    );
  } else if (status == 1) {
    ...
    cm.sendNextPrev(
      "Now, now, you may not understand the grandness of my experiments. I don''t expect you to. No, I don''t expect you to. Just focus on your job and make sure none of the test subjects run away."
    );
  } else if (status == 7) {
