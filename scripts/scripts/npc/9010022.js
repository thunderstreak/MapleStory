function start() {
  cm.askMapSelection(
    "#1# Mu Lung Training Center#2# Monster Carnival 1#3# Monster Carnival 2#4# Dual Raid#5# Nett's Pyramid#6# Kerning Subway#7# Happyville#8# Golden Temple#9# Crimsonwood Party Quest"
  );
}
