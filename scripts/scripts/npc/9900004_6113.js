...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      if (
        cm.haveItem(4031456, 20) &&
        cm.haveItem(4031311, 20) &&
        cm.haveItem(4000463, 5) &&
        cm.haveItem(4002000, 60) &&
        cm.haveItem(4002001, 60) &&
        cm.haveItem(4002002, 40) &&
        cm.haveItem(4002003, 20) &&
        cm.getMeso() >= 10000000
      ) {
      ...
      if (
        cm.haveItem(4031456, 40) &&
        cm.haveItem(4031311, 40) &&
        cm.haveItem(4000463, 10) &&
        cm.haveItem(4005004, 20) &&
        cm.haveItem(4005000, 20) &&
        cm.haveItem(4005001, 20) &&
        cm.haveItem(4005002, 20) &&
        cm.haveItem(4005003, 20) &&
        cm.haveItem(4001085, 1) &&
        cm.haveItem(1132243, 1) &&
        cm.getMeso() >= 20000000
      ) {
      ...
      if (
        cm.haveItem(4031456, 80) &&
        cm.haveItem(4031311, 80) &&
        cm.haveItem(4000463, 20) &&
        cm.haveItem(4031559, 100) &&
        cm.haveItem(4031558, 100) &&
        cm.haveItem(4001084, 1) &&
        cm.haveItem(1132244, 1) &&
        cm.getMeso() >= 30000000
      ) {
      ...
      if (
        cm.haveItem(4031456, 200) &&
        cm.haveItem(4031311, 200) &&
        cm.haveItem(4000463, 40) &&
        cm.haveItem(4001085, 1) &&
        cm.haveItem(4001084, 1) &&
        cm.haveItem(4001083, 1) &&
        cm.haveItem(1122000, 1) &&
        cm.haveItem(1132245, 1) &&
        cm.getMeso() >= 50000000
      ) {
