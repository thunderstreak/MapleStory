  ...
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      if (
        ...
        cm.haveItem(4032202, 10) &&
        cm.haveItem(4032203, 10) &&
        cm.haveItem(4032204, 10) &&
        cm.haveItem(4032205, 10) &&
        cm.haveItem(4032206, 10) &&
        cm.haveItem(4032207, 10) &&
        cm.haveItem(4032208, 10) &&
        cm.getMeso() > 15000000 &&
        !cm.getInventory(1).isFull()
      ) {
