...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    ...
    cm.sendPlayerToNpc(
      '(I went to the Temple of Time to take revenge on the Black Mage... On the way, I let Mastema go, to get away from the Commanders. Arkarium tried to stop me, but I was determined... I wonder how the Heroes did.)'
    );
  } else if (status == 4) {
    cm.sendPlayerToNpc(
      '(...The Black Mage was too powerful to me, but I thought I could do at least a little damage. All I managed was tearing his robe.. How pathetic... But how did I survive?...The Heroes?)'
    );
  } else if (status == 5) {
    ...
    cm.sendNextNoESC(
      "I've never seen skills like his. So powerful... If he hadn't used up all his power, I wouldn't have brought him here. He's dangerous. Is he a test subject? We must stop that blasted mad man Gelimer.\r\nIn any case, he should be up by now. I'll check on him.",
      2159342
    );
  } else if (status == 14) {
    ...
    cm.sendNextNoESC(
      "Yes, you were badly wounded. I can't just leave you there with the Black Wings. I think we're on the same side. We have plenty to talk about, so how about you come with me?",
      2159342
    );
  } else if (status == 17) {
