  ...
  if (status == 0) {
    ...
    if (selectedType == 0) {
      ...
      var crystals = new Array(
        '#t1082005##k - 剑士 等级. 30#b',
        '#t1082006##k - 剑士 等级. 30#b',
        '#t1082035##k - 剑士 等级. 35#b',
        '#t1082036##k - 剑士 等级. 35#b',
        '#t1082024##k - 剑士 等级. 40#b',
        '#t1082025##k - 剑士 等级. 40#b',
        '#t1082010##k - 剑士 等级. 50#b',
        '#t1082011##k - 剑士 等级. 50#b'
      );
      ...
      var selStr = '很好，那么你想做哪一个？？#b';
      var crystals = new Array(
        '#t1082049##k - 弓箭手 等级. 30#b',
        '#t1082050##k - 弓箭手 等级. 30#b',
        '#t1082069##k - 弓箭手 等级. 35#b',
        '#t1082070##k - 弓箭手 等级. 35#b',
        '#t1082072##k - 弓箭手 等级. 40#b',
        '#t1082073##k - 弓箭手 等级. 40#b',
        '#t1082085##k - 弓箭手 等级. 50#b',
        '#t1082083##k - 弓箭手 等级. 50#b'
      );
      for (var i = 0; i < crystals.length; i++) {
        selStr += '\r\n#L' + i + '# ' + crystals[i] + '#l';
      }
      ...
      var selStr = '很好，那么你想做哪一个？？#b';
      var items = new Array(
        '#t1082052##k - 法师 等级. 30#b',
        '#t1082053##k - 法师 等级. 30#b',
        '#t1082055##k - 法师 等级. 35#b',
        '#t1082056##k - 法师 等级. 35#b',
        '#t1082063##k - 法师 等级. 40#b',
        '#t1082064##k - 法师 等级. 40#b',
        '#t1082082##k - 法师 等级. 50#b',
        '#t1082080##k - 法师 等级. 50#b'
      );
      for (var i = 0; i < items.length; i++) {
        selStr += '\r\n#L' + i + '# ' + items[i] + '#l';
      }
      ...
      var gloves = new Array(
        '#t1082043##k - 盗贼 等级. 30#b',
        '#t1082044##k - 盗贼 等级. 30#b',
        '#t1082047##k - 盗贼 等级. 35#b',
        '#t1082045##k - 盗贼 等级. 35#b',
        '#t1082076##k - 盗贼 等级. 40#b',
        '#t1082074##k - 盗贼 等级. 40#b',
        '#t1082067##k - 盗贼 等级. 50#b',
        '#t1082066##k - 盗贼 等级. 50#b'
      );
      for (var i = 0; i < gloves.length; i++) {
        selStr += '\r\n#L' + i + '# ' + gloves[i] + '#l';
      }
