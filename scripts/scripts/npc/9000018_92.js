...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      text +=
        '#e#d制作#v1312184#需要#v1312037#x1.#v4000460#x15.#v4000461#x15.#v4000462#x15.#v4021009#x15.#v4011007#x15.#v4031891#2000万.搜集好道具我就可以为您制作了.#l\r\n全属性+15.攻击130.永恒武器为材料.合成后不计算加卷数量.\r\n'; //3
      text += '#L1##r制作伽耶汉武器#l\r\n\r\n'; //3
      cm.sendSimple(text);
    } else if (selection == 1) {
      //1
      ...
      /*if(!cm.beibao(1,3)){
        ...
        cm.haveItem(1312037, 1) &&
        cm.haveItem(4000460, 15) &&
        cm.haveItem(4000461, 15) &&
        cm.haveItem(4000462, 15) &&
