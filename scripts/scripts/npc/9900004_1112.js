...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      //第3天
      if (cm.getPlayer().getqiandao() >= 3 && cm.获取签到奖励领取状态() == 0) {
        //获取玩家签到状态
        cm.设置签到奖励领取状态(+1);
      ...
      //第5天
      if (cm.getPlayer().getqiandao() >= 5 && cm.获取签到奖励领取状态() == 1) {
        //获取玩家签到状态
        cm.设置签到奖励领取状态(+1);
      ...
      //第7天
      if (cm.getPlayer().getqiandao() >= 7 && cm.获取签到奖励领取状态() == 2) {
        //获取玩家签到状态
        cm.设置签到奖励领取状态(+1);
        cm.gainItem(4001126, 300); //枫叶*300
      ...
      //第15天
      if (cm.getPlayer().getqiandao() >= 10 && cm.获取签到奖励领取状态() == 3) {
        //获取玩家签到状态
        cm.设置签到奖励领取状态(+1);
      ...
      //第20天
      if (cm.getPlayer().getqiandao() >= 15 && cm.获取签到奖励领取状态() == 4) {
        //获取玩家签到状态
        cm.设置签到奖励领取状态(+1);
      ...
      //第25天
      if (cm.getPlayer().getqiandao() >= 20 && cm.获取签到奖励领取状态() == 5) {
        //获取玩家签到状态
        cm.设置签到奖励领取状态(+1);
      ...
      if (cm.getPlayer().getqiandao() >= 25 && cm.获取签到奖励领取状态() == 6) {
        //获取玩家签到状态
        cm.设置签到奖励领取状态(+1);
        cm.gainItem(4001126, 1000); //枫叶*1000
      ...
      //第30天
      if (cm.getPlayer().getqiandao() >= 30 && cm.获取签到奖励领取状态() == 7) {
        //获取玩家签到状态
        cm.设置签到奖励领取状态(+1);
        //奖励写在这里
        cm.gainItem(4001126, 1000); //枫叶*1000
