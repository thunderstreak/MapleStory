...
function action(mode, type, selection) {
  ...
  if (status == 0 && mode == 1) {
    ...
    if (selectedType == 0) {
      ...
      var suffix = new Array(' - 弓箭手 Lv. 10', ' - 弓箭手 Lv. 15', ' - 弓箭手 Lv. 20', ' - 弓箭手 Lv. 25', ' - 弓箭手 Lv. 30', ' - 弓箭手 Lv. 35', ' - 弓箭手 Lv. 40');
      equip = true;
      ...
      var suffix = new Array(' - 弓箭手 Lv. 12', ' - 弓箭手 Lv. 18', ' - 弓箭手 Lv. 22', ' - 弓箭手 Lv. 28', ' - 弓箭手 Lv. 32', ' - 弓箭手 Lv. 38', ' - 弓箭手 Lv. 42', ' - 弓箭手 Lv. 50');
      equip = true;
      for (var i = 0; i < items.length; i++) {
        selStr += '\r\n#L' + i + '##z' + items[i] + '##k' + suffix[i] + '#l#b';
      }
      ...
      var suffix = new Array(' - 弓箭手 Lv. 15', ' - 弓箭手 Lv. 20', ' - 弓箭手 Lv. 25', ' - 弓箭手 Lv. 30', ' - 弓箭手 Lv. 35', ' - 弓箭手 Lv. 40', ' - 弓箭手 Lv. 50', ' - 弓箭手 Lv. 60');
      equip = true;
      for (var i = 0; i < items.length; i++) {
        selStr += '\r\n#L' + i + '##z' + items[i] + '##k' + suffix[i] + '#l#b';
      }
    ...
    if (selectedType == 0) {
      ...
      var matSet = new Array(
        new Array(4003001, 4000000),
        new Array(4011001, 4003000),
        new Array(4003001, 4000016),
        new Array(4011001, 4021006, 4003000),
        new Array(4011001, 4011006, 4021003, 4021006, 4003000),
        new Array(4011004, 4021000, 4021004, 4003000),
        new Array(4021008, 4011001, 4011006, 4003000, 4000014)
      );
      ...
      var matSet = new Array(
        new Array(4003001, 4003000),
        new Array(4011001, 4003001, 4003000),
        new Array(4011001, 4003001, 4003000),
        new Array(4011001, 4021006, 4021002, 4003000),
        new Array(4011001, 4011005, 4021006, 4003001, 4003000),
        new Array(4021008, 4011001, 4011006, 4021006, 4003000),
        new Array(4021008, 4011004, 4003001, 4003000),
        new Array(4021008, 4011006, 4021006, 4003001, 4003000)
      );
      var matQtySet = new Array(
        ...
        new Array(1, 50, 8),
        new Array(2, 1, 1, 10),
        new Array(5, 5, 3, 50, 15),
        new Array(1, 8, 4, 2, 30),
        new Array(2, 6, 30, 30),
        new Array(2, 5, 3, 40, 40)
      );
      ...
      var matSet = new Array(
        new Array(4000021, 4000009),
        new Array(4000021, 4000009, 4011001),
        new Array(4000021, 4000009, 4011006),
        ...
        new Array(4011006, 4011007, 4021006, 4000030, 4003000)
      );
      var matQtySet = new Array(
        new Array(15, 20),
        new Array(20, 20, 2),
      ...
      var matSet = new Array(
        new Array(1082013, 4021003),
        new Array(1082013, 4021000),
        new Array(1082016, 4021000),
        new Array(1082016, 4021008),
        ...
        new Array(1082089, 4021000, 4021007),
        new Array(1082089, 4021007, 4021008)
      );
      var matQtySet = new Array(
        new Array(1, 2),
        new Array(1, 1),
    ...
    if (!complete) cm.sendOk('你如果不能给我带来这些材料，我无法帮你制作');
    else {
      if (cm.canHold(item)) {
        if (mats instanceof Array) {
          for (var i = 0; i < mats.length; i++) {
