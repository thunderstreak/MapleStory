...
var answers = new Array(
  new Array('狸猫柴火', '独角狮的硬角', '红色的砖'),
  new Array('6', '5', '4'),
  new Array('章鱼烧', '福建面', '面粉'),
  new Array('乌鸦屎', '黄色雨伞', '骆驼蛋'),
  new Array('冻冻鱼', '寒冰破魔枪', '苍蝇拍'),
  new Array('萨米', '卡米', '由美'),
  new Array('云狐的牙齿', '花束', '狐狸的尾巴'),
  new Array('商荣繁盛', '全场一折', '欢迎光临'),
  new Array('竹矛-战士唯一的武器', '橡皮榔头-单手剑', '龙背刃-双手剑'),
  new Array('蛋炒面', '日本炒面', '蘑菇特制拉面'),
  new Array('武大郎', '樱桃小丸子', '绘里香')
);
