...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    ...
    cm.sendPlayerToNpc(
      "My name is #h0#. I am not currently part of any organization, though I was once one of the Black Mage's Commanders. I rebelled against him, and we fought, but he defeated me. When I awoke, I saw the Black Wings. Oh, and I was born with these wings. I am a demon."
    );
  } else if (status == 7) {
    ...
    cm.sendNextNoESC(
      "We're the resistance, a group formed in secret to protect our home, Edelstein, from the Black Wings. Those nasty folks stealing your energy were the Black Wings. They have been draining energy from the city since a while back, and they work for the Black Mage.",
      2159342
    );
  } else if (status == 16) {
    ...
    cm.sendNextNoESC(
      'He seems to hate the Black Mage as much as we do, if not more. Even if he #bused to be#k a Commander, he is not one any more. We can always use more members, as long as our goals are the same. We can work together.',
      2159342
    );
  } else if (status == 22) {
