  ...
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      if (!cm.canHold(1012060, 1)) {
        ...
        cm.haveItem(4000151, 50) &&
        cm.haveItem(4000152, 50) &&
        cm.haveItem(1113036, 1) &&
        cm.haveItem(4000406, 100) &&
        cm.haveItem(4000402, 100) &&
        cm.haveItem(4000407, 100) &&
        cm.getMeso() >= 50000000
      ) {
