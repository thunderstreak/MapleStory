...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    ...
    if (!cm.haveItem(exchangeItem, 100)) {
      ...
      cm.sendGetNumber(
        '嗯，这是个好主意！ 我可以给你 #i2022457#每100个 #i' + exchangeItem + '##t' + exchangeItem + '# 你想要给我多少 (当前道具: ' + cm.getPlayer().itemQuantity(exchangeItem) + ')',
        java.lang.Math.min(300, cm.getPlayer().itemQuantity(exchangeItem) / 100),
        1,
        java.lang.Math.min(300, cm.getPlayer().itemQuantity(exchangeItem) / 100)
      );
    }
