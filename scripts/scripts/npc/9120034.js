...
function action(mode, type, selection) {
  ...
  switch (status) {
    case 0:
      if (selection == 0) {
        cm.sendNext(
          'My name is Noran, technical personnel. Here, everyone is talking about you. If you could defeat mechanic monster, I wish to help you too. With blaze technology, more powerful item can be created.'
        );
      } else {
        status = 9;
    ...
    case 1:
      cm.sendNextPrev(
        "It's been said that Blaze has succeeded to collect energy floating in universe. If this is true, massive energy can be obtained. Small portion of this energy can be extracted from Sealed Warrior Stone but it must be unsealed in order to be used. Bring it to me and i will release it's seal."
      );
      break;
    case 2:
      cm.sendSimple(
        'Give me the sealed stone \r #b#L0#Give Sealed Warrior Stone and service fee. 1,000 Silver Coin#l \r #L1#Give Sealed Wiseman Stone and service fee. 1,000 Silver Coin#l \r #L2#Give Sealed Saint Stone and service fee. 1,000 Silver Coin#l'
      );
      break;
    case 3:
      if (selection == 0) {
