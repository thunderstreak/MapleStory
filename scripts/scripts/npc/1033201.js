...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    ...
    cm.sendNextNoESC(
      "You can't feel it? Mercedes, the great curse... has been place upon you, Freud, and the others. An icy, cold curse, clinging to you. It looks like the Black Mage isn't letting us off so easily.."
    );
  } else if (status == 6) {
    cm.sendPlayerToNpc('A c-curse... you should be able to survive it, but what about Freud? He looks weak...');
  } else if (status == 7) {
    cm.sendNextNoESC(
      "I'll take care of him. For now, I'm more worried about you. You're the #bruler of the Elves.#k If the curse is on you, it'll be placed on #rall of the Elves!#k Hurry back to #bElluel#k If the #bBlack Mage's curse is on all of the Elves#k, then you must return to  your people."
    );
  } else if (status == 8) {
