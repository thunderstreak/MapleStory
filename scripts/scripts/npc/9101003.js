...
var itemtk1 = Array(
  ...
  Array(
    ...
    '营养物质摄入过多时，一定使人发胖',
    '营养物质摄入过多时，一定排出',
    '营养物质摄入过多时，氧化分解加强，释放能量多',
    '在人体内可以利用必需氨基酸合成非必需氨基酸',
    '4'
  ),
  ...
  Array(
    '豆浆又叫植物奶，被国际营养协会评定为健康食品和世界六大营养饮料之一。但是喝豆浆也有注意事项，以下正确的食用方法是',
    '喝没有煮沸的豆浆',
    '豆浆中冲入鸡蛋',
    '喝豆浆时搭配其他食物',
    '用保温瓶长时间储存豆浆',
...
var itemtk2 = Array(
  ...
  Array('标志着教育学作为一门独立的学科开始形成的教育论著是', '《学记》', '《普通教育学》', '《大教学论》', '《教育论》', '3'),
  Array('下列不属于骑士七技的范围的是', '骑马', '投枪', '音乐', '吟诗', '3'),
