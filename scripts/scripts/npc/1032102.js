    ...
    if (status == 0) {
      ...
      if (selection == 0) {
        ...
        if (pet == null || !cm.haveItem(5380000, 1)) {
          cm.sendOk(
            '我可能没办法帮助你. 你必须给我 #i5380000##t5380000#, 如果你的宠物是以下之一： #d#i5000029##t5000029##k, #g#i5000030##t5000030##k, #r#i5000031##t5000031##k, #b#i5000032##t5000032##k, 或者 #e#i5000033##t5000033##n 只要等级达到15级，我就可以帮你升级哟.'
          );
          cm.dispose();
        } else {
        ...
        if (pet == null || !cm.haveItem(5380000, 1)) {
          cm.sendOk(
            '我可能无法帮助你！ 你必须给我 #i5380000##t5380000#,如果你的宠物是以下之一： #g#i5000048##t5000048##k, #r#i5000049##t5000049##k, #b#i5000050##t5000050##k, #d#i5000051##t5000051##k, #d#i5000052##t5000052##k, 或者 #e#i5000053##t5000053##n 只要等级达到15级，我就可以帮你升级哟.'
          );
          cm.dispose();
        } else {
          var id = pet.getPetItemId();
