...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    cm.sendNext(
      '安安 我是阿勒米  I know how to make the firecrackers!  If you can gather and give me Power Keg then, we can have a fireworks!  Please get all the powder kegs that you get from the monsters.'
    );
  } else if (status == 1) {
    ...
    if (selection == 1) {
      ...
      cm.sendGetNumber(
        'Did you bring the powder keg with you? Then, please give me the #bPowder Keg#k you have.  I will make a nice firecracker.  How many are you willing to give me? \n\r #b< Number of Powder Keg in inventory : 0 >#k',
        0,
        0,
        1000
      );
