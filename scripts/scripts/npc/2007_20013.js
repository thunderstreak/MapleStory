...
function action(mode, type, selection) {
  ...
  if (cm.获取当前星期() == 1 || cm.获取当前星期() == 2 || cm.获取当前星期() == 3 || cm.获取当前星期() == 4 || cm.获取当前星期() == 5 || cm.获取当前星期() == 6) {
    ...
    if (
      cm.getPlayer().getInventory(cm.getInvType(-1)).findById(1142099) ||
      cm.haveItem(1142099) ||
      cm.getPlayer().getInventory(cm.getInvType(-1)).findById(1142098) ||
      cm.haveItem(1142098) ||
      cm.getPlayer().getInventory(cm.getInvType(-1)).findById(1142097) ||
      cm.haveItem(1142097) ||
      cm.getPlayer().getInventory(cm.getInvType(-1)).findById(1142096) ||
      cm.haveItem(1142096) ||
      cm.getPlayer().getInventory(cm.getInvType(-1)).findById(1142095) ||
      cm.haveItem(1142095) ||
      cm.getPlayer().getInventory(cm.getInvType(-1)).findById(1142094) ||
      cm.haveItem(1142094) ||
      cm.getPlayer().getInventory(cm.getInvType(-1)).findById(1142093) ||
      cm.haveItem(1142093) ||
      cm.getPlayer().getInventory(cm.getInvType(-1)).findById(1142092) ||
      cm.haveItem(1142092) ||
      cm.getPlayer().getInventory(cm.getInvType(-1)).findById(1142091) ||
      cm.haveItem(1142091) ||
      cm.getPlayer().getInventory(cm.getInvType(-1)).findById(1142089) ||
      cm.haveItem(1142089)
    ) {
