  ...
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      if (cm.getPlayer().getGamePoints() >= 60 && cm.getPlayer().getGamePointsPD() == 0) {
        text += '#L2##r' + 完成红 + '在线时间超过60分钟！' + 完成 + '金币*20W#v2022035#*1个#v2020031#*1个#v2000019#*60个\r\n\r\n\r\n\r\n'; //3
      } else if (cm.getPlayer().getGamePoints() >= 60 && cm.getPlayer().getGamePointsPD() > 0) {
        text += '' + 完成红 + '#r在线时间超过60分钟！#l' + 完成 + '金币*20W#v2022035#*1个#v2020031#*1个#v2000019#*60个\r\n\r\n'; //3
      } else {
        text += '' + 正在进行中蓝 + '#r在线时间超过60分钟！#l' + 正在进行中 + '金币*20W#v2022035#*1个#v2020031#*1个#v2000019#*60个\r\n\r\n'; //3
      }
      if (cm.getPlayer().getGamePoints() >= 120 && cm.getPlayer().getGamePointsPD() == 1) {
        text += '#L3##r' + 完成红 + '在线时间超过120分钟！' + 完成 + '金币*40W 点卷*1000 #v5440000#*1200 \r\n\r\n\r\n'; //3
      } else if (cm.getPlayer().getGamePoints() >= 120 && cm.getPlayer().getGamePointsPD() > 1) {
        text += '' + 完成红 + '#r在线时间超过120分钟！#l' + 完成 + '金币*40W 点卷*1000 #v5440000#*1200\r\n\r\n'; //3
      } else {
        text += '' + 正在进行中蓝 + '#r在线时间超过120分钟！#l' + 正在进行中 + '金币*40W 点卷*1000 #v5440000#*1200\r\n\r\n'; //3
      }
      if (cm.getPlayer().getGamePoints() >= 180 && cm.getPlayer().getGamePointsPD() == 2) {
        text += '#L4##r' + 完成红 + '在线时间超过180分钟！' + 完成 + '金币*80W #v5440000#*1800 #v2049116#*20个 \r\n\r\n\r\n'; //3
      } else if (cm.getPlayer().getGamePoints() >= 180 && cm.getPlayer().getGamePointsPD() > 2) {
        text += '' + 完成红 + '#r在线时间超过180分钟！#l' + 完成 + '金币*80W #v5440000#*1800 #v2049116#*20个\r\n\r\n'; //3
      } else {
        text += '' + 正在进行中蓝 + '#r在线时间超过180分钟！#l' + 正在进行中 + '金币*80W #v5440000#*1800 #v2049116#*20个\r\n\r\n'; //3
      }
      if (cm.getPlayer().getGamePoints() >= 240 && cm.getPlayer().getGamePointsPD() == 3) {
        text += '#L5##r' + 完成红 + '在线时间超过240分钟！' + 完成 + '金币*100W #v5440000#*2400 #v2340000#*20个\r\n\r\n\r\n'; //3
      } else if (cm.getPlayer().getGamePoints() >= 240 && cm.getPlayer().getGamePointsPD() > 3) {
        text += '' + 完成红 + '#r在线时间超过240分钟！#l' + 完成 + '金币*100W #v5440000#*2400 #v2340000#*20个\r\n\r\n'; //3
      } else {
        text += '' + 正在进行中蓝 + '#r在线时间超过240分钟！#l' + 正在进行中 + '金币*100W #v5440000#*2400 #v2340000#*20个\r\n\r\n'; //3
      }
      if (cm.getPlayer().getGamePoints() >= 300 && cm.getPlayer().getGamePointsPD() == 4) {
        text += '#L8##r' + 完成红 + '在线时间超过420分钟！' + 完成 + '#v5440000#*4200 #v2000004#*50个 金币*200W\r\n\r\n\r\n'; //3
      } else if (cm.getPlayer().getGamePoints() >= 300 && cm.getPlayer().getGamePointsPD() > 4) {
        text += '' + 完成红 + '#r在线时间超过420分钟！#l' + 完成 + '#v5440000#*4200 #v2000004#*50个 金币*200W\r\n\r\n'; //3
      } else {
        text += '' + 正在进行中蓝 + '#r在线时间超过300分钟！#l' + 正在进行中 + '#v5440000#*4200 #v2000004#*50个 金币*200W\r\n\r\n'; //3
      }
      if (cm.getPlayer().getGamePoints() >= 360 && cm.getPlayer().getGamePointsPD() == 5) {
        text += '#L7##r' + 完成红 + '在线时间超过360分钟！' + 完成 + '金币*500W #v5440000#*3600 #v2010006#*1个#k\r\n\r\n\r\n'; //3
      } else if (cm.getPlayer().getGamePoints() >= 360 && cm.getPlayer().getGamePointsPD() > 5) {
        text += '' + 完成红 + '#r在线时间超过360分钟！#l' + 完成 + '金币*500W #v5440000#*3600 #v2010006#*1个#k\r\n\r\n'; //3
      } else {
        text += '' + 正在进行中蓝 + '#r在线时间超过360分钟！#l' + 正在进行中 + '金币*500W #v5440000#*3600 #v2010006#*1个#k\r\n\r\n'; //3
      }
      if (cm.getPlayer().getGamePoints() >= 420 && cm.getPlayer().getGamePointsPD() == 6) {
        text += '#L8##r' + 完成红 + '在线时间超过420分钟！' + 完成 + '金币1000W+点卷5000+#v2000019#80个+#v4251202#1个+#v2002031#2个\r\n\r\n\r\n'; //3
      } else if (cm.getPlayer().getGamePoints() >= 420 && cm.getPlayer().getGamePointsPD() > 6) {
        text += '' + 完成红 + '#r在线时间超过420分钟！#l' + 完成 + '金币1000W+点卷5000+#v2000019#80个+#v4251202#1个+#v2002031#2个\r\n\r\n'; //3
      } else {
        text += '' + 正在进行中蓝 + '#r在线时间超过420分钟！#l' + 正在进行中 + '金币1000W+点卷5000+#v2000019#80个+#v4251202#1个+#v2002031#2个\r\n\r\n'; //3
      }
      cm.sendSimple(text);
    } else if (selection == 1) {
