...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    cm.sendYesNo(
      '希望今天客人能多一点……啊！等一下！你想增加好友目录吗？我一看你，就觉得你有很多朋友。怎么样……只要花一点钱，我就可以为你增加好友目录。但是不会应用于相同帐号的其他角色，所以一定要慎重。你想增加吗？'
    );
  } else if (status == 1) {
    cm.sendYesNo(
      '好的！明智的决定。价格不贵。因为#r特殊折扣#k活动开始了，#b好友目录添加5名一共是25万金币#k。当然，绝不零售。只要购买一次，目录就可以永久增加。对好友目录不足的人来说，这个买卖应该不坏。怎么样？你愿意支付25万金币吗？'
    );
  } else if (status == 2) {
