...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      if (cm.canHold(4001215, 1) && cm.getPlayer().getCSPoints(1) < 2000) {
        // Not Party Leader
      ...
      if (cm.canHold(4001215, 10) && cm.getPlayer().getCSPoints(1) < 19000) {
        // Not Party Leader
      ...
      if (cm.canHold(4001215, 100) && cm.getPlayer().getCSPoints(1) < 180000) {
        // Not Party Leader
