...
function action(mode, type, selection) {
  ...
  if (cm.getMapId() == 10000) {
    ...
    if (
      cm.haveItem(4021000, 70) &&
      cm.haveItem(4021001, 70) &&
      cm.haveItem(4021002, 70) &&
      cm.haveItem(4021003, 70) &&
      cm.haveItem(4021004, 70) &&
      cm.haveItem(4021005, 70) &&
      cm.haveItem(4021006, 70) &&
      cm.haveItem(4021007, 70) &&
      cm.haveItem(4021008, 70) &&
      cm.haveItem(4011007, 15) &&
      cm.haveItem(4021009, 15) &&
