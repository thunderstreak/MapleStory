...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      text += ' \t  #e#d欢迎来到#r冒险岛VIP月卡签到中心#k#n\r\n';
      ...
      if (cm.getBossLog('1vipqiandao') == 0 && cm.haveItem(3700150, 1)) {
        //获取玩家签到状态
      ...
      if (cm.getBossLog('2vipqiandao') == 0 && cm.haveItem(3700149, 1)) {
        //获取玩家签到状态
      ...
      if (cm.getBossLog('3vipqiandao') == 0 && cm.haveItem(3700148, 1)) {
        //获取玩家签到状态
