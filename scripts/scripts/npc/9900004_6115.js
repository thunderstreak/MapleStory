...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      if (
        cm.haveItem(4001126, 300) &&
        cm.haveItem(4031559, 40) &&
        cm.haveItem(4031558, 40) &&
        cm.haveItem(4002003, 40) &&
        cm.haveItem(4021010, 1) &&
      ...
      if (
        ...
        cm.haveItem(1032220, 1) &&
        cm.haveItem(4031559, 60) &&
        cm.haveItem(4031558, 60) &&
        cm.haveItem(4002003, 60) &&
        cm.haveItem(4021010, 1) &&
      ...
      if (
        ...
        cm.haveItem(1032221, 1) &&
        cm.haveItem(4031559, 80) &&
        cm.haveItem(4031558, 80) &&
        cm.haveItem(4002003, 80) &&
        cm.haveItem(4021010, 2) &&
      ...
      if (
        ...
        cm.haveItem(1032222, 1) &&
        cm.haveItem(4031559, 100) &&
        cm.haveItem(4031558, 100) &&
        cm.haveItem(4002003, 100) &&
        cm.haveItem(4021010, 3) &&
