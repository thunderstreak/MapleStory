  ...
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      var a2 =
        '#L2#' +
        红色箭头 +
        ' #r四维+6攻击力/魔法力+3的#v1032207##l\r\n\r\n' +
        圆形 +
        '1个#v1032206# 300个#v4000051# 300个#v4000048# 300个#v4000052# \r\n 3个#v4002003# 3个#v4002001# 3个#v4002002# 3个#v4000463# 6个#v4031196#300W#v2140002#\r\n'; //0
      var a3 =
        '#L3#' +
        红色箭头 +
        ' #r四维+8攻击力/魔法力+4的#v1032208##l\r\n\r\n' +
        圆形 +
        '1个#v1032207# 400个#v4000233# 400个#v4000232# 400个#v4000234# \r\n 4个#v4002003# 4个#v4002001# 4个#v4002002# 4个#v4000463# 8个#v4031196#400W#v2140002#\r\n'; //0
      var a4 =
        '#L4#' +
        红色箭头 +
        ' #r四维+10攻击力/魔法力+5的#v1032209##l\r\n\r\n' +
        圆形 +
        '1个#v1032208# 500个#v4000453# 500个#v4000448# 500个#v4000458# \r\n 5个#v4002003# 5个#v4002001#5个#v4002002#5个#v4000463# 10个#v4031196#500W#v2140002#\r\n'; //0
      var a7 =
        '#L7#' +
        红色箭头 +
        ' #r四维+30攻击力/魔法力+30的#v1032219##l\r\n\r\n' +
        圆形 +
        '1个#v1032209# 10个#v4030002# 10个#v4030003# 10个#v4030004# \r\n 10个#v4030005# 10个#v4030006#10个#v4030007#10个#v4030008#1500W#v2140002#\r\n'; //0
      ...
      //套装
      if (
        cm.haveItem(1032206, 1) &&
        cm.haveItem(4000051, 300) &&
        cm.haveItem(4000048, 300) &&
        cm.haveItem(4000052, 300) &&
        cm.haveItem(4002003, 3) &&
        cm.haveItem(4002001, 3) &&
        cm.haveItem(4002002, 3) &&
        cm.haveItem(4000463, 3) &&
        cm.haveItem(4031196, 6) &&
        cm.getMeso() > 3000000 &&
      ...
      //手套
      if (
        cm.haveItem(1032207, 1) &&
        cm.haveItem(4000233, 400) &&
        cm.haveItem(4000232, 400) &&
        cm.haveItem(4000234, 400) &&
        cm.haveItem(4002003, 4) &&
        cm.haveItem(4002001, 4) &&
        cm.haveItem(4002002, 4) &&
        cm.haveItem(4000463, 4) &&
        cm.haveItem(4031196, 8) &&
        cm.getMeso() > 4000000 &&
        !cm.getInventory(1).isFull()
      ) {
      ...
      //鞋子
      if (
        cm.haveItem(1032208, 1) &&
        cm.haveItem(4000453, 500) &&
        cm.haveItem(4000448, 500) &&
        cm.haveItem(4000458, 500) &&
        cm.haveItem(4002003, 5) &&
        cm.haveItem(4002001, 5) &&
        cm.haveItem(4002002, 5) &&
        cm.haveItem(4000463, 5) &&
        cm.haveItem(4031196, 10) &&
        cm.getMeso() > 5000000 &&
        !cm.getInventory(1).isFull()
      ) {
      ...
      //鞋子
      if (
        cm.haveItem(1032209, 1) &&
        cm.haveItem(4030002, 10) &&
        cm.haveItem(4030003, 10) &&
        cm.haveItem(4030004, 10) &&
        cm.haveItem(4030005, 10) &&
        cm.haveItem(4030006, 10) &&
        cm.haveItem(4030007, 10) &&
        cm.haveItem(4030008, 10) &&
        cm.getMeso() > 15000000 &&
        !cm.getInventory(1).isFull()
      ) {
