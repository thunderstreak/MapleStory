  ...
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      if (selection == 0) {
        ...
        cm.sendSimple(
          '这个事件有很多游戏。在你玩游戏之前，它会帮助你知道如何玩游戏。选择一个你想知道更多的! #b\r\n#L0# Ola Ola#l\r\n#L1# 冒险岛枫体能测试#l\r\n#L2# 滚雪球比赛#l\r\n#L3# 打椰子比赛#l\r\n#L4# 0X智力测试#l\r\n#L5# 寻宝#l#k'
        );
      } else if (selection == 2) {
        if (!cm.canHold()) {
