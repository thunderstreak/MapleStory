...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    ...
    if (sel == 0) {
      ...
      cm.sendYesNo(
        'Are you sure you want to make a #b' + newWepName + '#k? The following items and materials will be required...\r\n#i4001126# x' + leaves + '#k\r\n\r\n#fUI/UIWindow.img/QuestIcon/7/0# ' + cost
      );
      // 1482020
    } else if (sel == 2) {
      if (selection == 0) {
      ...
      cm.sendYesNo(
        'Are you sure you want to make a #b' +
          newWepName +
          '#k? The following items and materials will be required...\r\n\r\n#i' +
          oldWepId +
          '# x 1\r\n#i4001126# x' +
          leaves +
    ...
    if (sel == 2 || sel == 4) {
      if (mode != 1) {
        ...
        if (cm.getMeso() < cost || !cm.haveItem(oldWepId, 1) || !cm.haveItem(4001126, leaves)) {
          ...
          status = 2;
          cm.sendSimple(
            'It appears that you have a #rStimulator#k for this weapon. Would you like to create the weapon with or without the #rStimulator#k? If you create without the #rStimulator#k, the item will always be #baverage#k. If you do create it with the #rStimulator#k, the item has a random chance of being #blower#k or #bhigher#k than average.\r\n#b#L20#Create weapon WITH Stimulator#l\r\n#L21#Create weapon WITHOUT Stimulator#l#k'
          );
        }
      }
    } else if (sel == 0 || sel == 1) {
