...
function action(mode, type, selection) {
  if (mode == 0) {
    ...
    if (cm.getPlayer().getBattler(0) != null || cm.getPlayer().getBoxed().size() >= 1) {
      ...
      cm.sendNext(
        "Hey, hey ... I don't think you have any minions to train ... Maybe you could get one from my friend if they feel nice... You can talk to my friend by doing the command: #b@pokemon#k"
      );
    }
  }
  cm.dispose();
