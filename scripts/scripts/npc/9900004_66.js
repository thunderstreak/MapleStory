...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      text +=
        '#e#d制作#v1442104#需要#v1302064#1.#v1332056#1.#v1372034#1.#v1382039#1.#v1432040#1.#v1442051#1.#v1452045#1.#v1462040#1.#v1402039#1.#v1472055#1.#v1312032#1.#v1322054#1.#v1482022#1.#v1492022#1.#v4002000#50.冒险币500万搜集好道具我就可以为您制作了.#l\r\n\r\n'; //3
      text += '#L1##r制作枫叶武器#l\r\n\r\n'; //3
      cm.sendSimple(text);
    } else if (selection == 1) {
