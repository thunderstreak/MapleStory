  ...
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      switch (selection) {
        ...
        case 7:
          if (
            cm.haveItem(2020007, 20) &&
            cm.haveItem(2002023, 80) &&
            cm.haveItem(4310149, 20) &&
            cm.haveItem(1102481, 1) &&
            cm.haveItem(1082543, 1) &&
            cm.haveItem(1072743, 1) &&
            cm.haveItem(1132174, 1)
          ) {
        ...
        case 8:
          if (
            ...
            cm.haveItem(2002023, 80) &&
            cm.haveItem(4310149, 20) &&
            cm.haveItem(1102482, 1) &&
            cm.haveItem(1082544, 1) &&
            cm.haveItem(1072744, 1) &&
            cm.haveItem(1132175, 1)
          ) {
            cm.sendOk('恭喜你，合成200级神装四件成功! .');
            cm.gainItem(2020007, -20);
            cm.gainItem(2002023, -80);
        ...
        case 9:
          if (
            ...
            cm.haveItem(2002023, 80) &&
            cm.haveItem(4310149, 20) &&
            cm.haveItem(1102483, 1) &&
            cm.haveItem(1082545, 1) &&
            cm.haveItem(1072745, 1) &&
            cm.haveItem(1132176, 1)
          ) {
            cm.sendOk('恭喜你，合成200级神装四件成功! .');
            cm.gainItem(2020007, -20);
            cm.gainItem(2002023, -80);
        ...
        case 10:
          if (
            ...
            cm.haveItem(2002023, 80) &&
            cm.haveItem(4310149, 20) &&
            cm.haveItem(1102484, 1) &&
            cm.haveItem(1082546, 1) &&
            cm.haveItem(1072746, 1) &&
            cm.haveItem(1132177, 1)
          ) {
            cm.sendOk('恭喜你，合成200级神装四件成功! .');
            cm.gainItem(2020007, -20);
            cm.gainItem(2002023, -80);
        ...
        case 11:
          if (
            ...
            cm.haveItem(2002023, 80) &&
            cm.haveItem(4310149, 20) &&
            cm.haveItem(1102485, 1) &&
            cm.haveItem(1082547, 1) &&
            cm.haveItem(1072747, 1) &&
            cm.haveItem(1132178, 1)
          ) {
            cm.sendOk('恭喜你，合成200级神装四件成功! .');
            cm.gainItem(2020007, -20);
            cm.gainItem(2002023, -80);
