      ...
      if (itemspeed >= 295) {
        ...
        if (cm.getPlayer().getItemQuantity(4000464, false) < price) {
          ...
          if (chance_random <= chance_value) {
            ...
            if (itemspeed > 40) speed_random = 0;
            if (itemjump > 23) jump_random = 0; // str,dex,luk,int,hp,mp,watk,matk,wdef,mdef,avoid,acc,jump,speed,time
            cm.gainItem(
              itemid,
              itemstr + str_random,
              itemdex + dex_random,
              ...
              itemmatk + matk_random,
              itemwdef + wdef_random,
              itemmdef + mdef_random,
              itemavoid + avoid_random,
              itemacc + acc_random,
              0,
              0
            ); //item.getItemId(),  ,speed=295
