    ...
    if (status == 0) {
      ...
      if (selection == 0) {
        if (cm.getPlayer().getCSPoints(1) / 30 == 0) {
          ...
          beauty = 1;
          cm.sendGetNumber(
            '请输入#r点卷#k兑换#b#z4000463##k的数量:\r\n#b比例 - (#r1000 = 1#b)\r\n你的账户信息 -  点卷数量: #r' + cm.getPlayer().getCSPoints(1) + ' \r\n',
            1,
            1,
            cm.getPlayer().getCSPoints(1) / 1000
          );
        }
      } else if (selection == 1) {
        ...
        if (cm.haveItem(4000313) == 0) {
          ...
          beauty = 2;
          cm.sendGetNumber(
            '请输入#b#z4000313##k兑换#r点卷#k的数量:\r\n#b比例 - (#r1 = 10#b)\r\n你的账户信息 - \r\n    点卷数量: #r' + cm.getPlayer().getCSPoints(1) + '    \r\n',
            1,
            1,
            iter.next().getQuantity()
          );
        }
      } else if (selection == 3) {
