...
var prizeIdScroll = Array(
  2040502,
  2040505, // Overall DEX and DEF
  2040802, // Gloves for DEX
  2040002,
  2040402,
  2040602
); // Helmet, Topwear and Bottomwear for DEF
var prizeIdUse = Array(
  2000001,
  2000002,
  2000003,
  2000006, // Orange, White and Blue Potions and Mana Elixir
  2000004,
  2022000,
  2022003
); // Elixir, Pure Water and Unagi
var prizeQtyUse = Array(80, 80, 80, 50, 5, 15, 15);
var prizeIdEquip = Array(
  1032004,
  1032005,
  1032009, // Level 20-25 Earrings
  1032006,
  1032007,
  1032010, // Level 30 Earrings
...
var prizeIdEtc = Array(
  ...
  4010001,
  4010002,
  4010003, // Mineral Ores
  4010004,
  4010005,
  4010006, // Mineral Ores
  4020000,
  4020001,
  4020002,
  4020003, // Jewel Ores
...
function action(mode, type, selection) {
  ...
  if (curMap == 1) {
    ...
    if (cm.isLeader()) {
      ...
      if (preamble == null) {
        cm.sendNext(
          '你好，欢迎来到第一个阶段，在这里你可能会考到很多凶狠的鳄鱼，跟我对话，我会给你们每一个人出一道题目，你们再打倒凶狠的鳄鱼获取相应数目的证书卡交给我，就行了。之后我会给你们一张通行证，你们把通行证全部交给组队长，组队长再和我讲话，就可以顺利通关了，那么祝你一切顺利！'
        );
      ...
      if (status == 0) {
        if (preamble == null) {
          ...
          if (complete != null) {
            ...
            } else cm.sendNext('对不起，那不是正确的答案！请检查您的背包中有正确数量的证书。 .');
          }
          cm.dispose();
        }
      } else if (status == 1) {
      ...
      if (preamble == null) {
        ...
        if (complete != null) {
          ...
          if (playersOnCombo == 3) {
            ...
            for (i = 0; i < objset.length && correctCombo; i++) if (combo[i] != objset[i]) correctCombo = false;
