...
function action(mode, type, selection) {
  if (mode == -1) {
    ...
    if (a == -1) {
      ...
      selectn2 = selection;
      for (var i = 0; i < 10; i++) {
        if (i != selectn1 && i != selectn2) str += '#L' + i + '#' + i;
      }
      str += '#l';
      ...
      selectn3 = selection;
      for (var i = 0; i < 10; i++) {
        if (i != selectn1 && i != selectn2 && i != selectn3) str += '#L' + i + '#' + i;
      }
      str += '#l';
      ...
      selectn4 = selection;
      for (var i = 0; i < 10; i++) {
        if (i != selectn1 && i != selectn2 && i != selectn3 && i != selectn4) str += '#L' + i + '#' + i;
      }
      str += '#l';
      ...
      str_unlocklog = '';
      for (var i = 0; i < unlocklog.length; i++) str_unlocklog += unlocklog[i];
      if (postrue == 5) {
