  ...
  if (mode == -1) {
    ...
    if (status == 0) {
      ...
      if (selection == 1) {
        //红
        if (
          cm.haveItem(1102041, 1) &&
          cm.haveItem(4002000, 50) &&
          cm.haveItem(4002001, 30) &&
          cm.haveItem(4000463, 50) &&
          cm.haveItem(4031456, 50) &&
          cm.haveItem(4170007, 10) &&
          cm.getMeso() > 5000000
        ) {
        ...
        //红
        if (
          cm.haveItem(1102040, 1) &&
          cm.haveItem(4002000, 100) &&
          cm.haveItem(4002001, 50) &&
          cm.haveItem(4000463, 66) &&
          cm.haveItem(4031456, 100) &&
          cm.haveItem(4170007, 20) &&
          cm.getMeso() > 10000000
        ) {
        ...
        //红
        if (
          cm.haveItem(1102042, 1) &&
          cm.haveItem(4002000, 200) &&
          cm.haveItem(4002001, 80) &&
          cm.haveItem(4000463, 80) &&
          cm.haveItem(4031456, 200) &&
          cm.haveItem(4170007, 30) &&
          cm.getMeso() > 20000000
        ) {
